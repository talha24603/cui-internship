...
const navItems = [
  ...
  { href: "/faculty/profile", label: "Profile", icon: UserRoundCog },
  { href: "/faculty/internships", label: "Internships", icon: Users },
  { href: "/faculty/appex-a-approvals", label: "AppEx A", icon: ClipboardCheck },
  { href: "/faculty/appex-b-verification", label: "AppEx B Verify", icon: ListChecks },
  { href: "/faculty/evaluation-form", label: "Evaluation Form", icon: FileText },
  { href: "/faculty/evaluation-summary", label: "Summary", icon: NotebookTabs },
  { href: "/faculty/finalization", label: "Finalization", icon: ScrollText },
  { href: "/faculty/weekly-logs", label: "Weekly Logs", icon: ListChecks },
  { href: "/faculty/complaints", label: "Complaints", icon: MessageSquareWarning },
];

export default function FacultyShell({ title, description, children }: FacultyShellProps) {
  ...
  const activePath = useMemo(() => pathname || "/faculty", [pathname]);
      ...
      <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[280px_1fr]">
        ...
        >
          <div className="mb-5 flex items-center gap-3 border-b border-slate-200 pb-4 dark:border-slate-800">
            ...
            <div>
              <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">Faculty Portal</p>
