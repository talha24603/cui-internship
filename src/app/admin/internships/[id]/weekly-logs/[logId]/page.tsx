...
export default function AdminWeeklyLogDetailPage() {
  ...
  return (
    <AdminShell title="Weekly Log Detail" description="Read weekly log on a dedicated full page.">
      <div className="mb-4">
        <Button asChild variant="outline" size="sm">
          <Link href={`/admin/internships/${internshipId}`}>Back to internship details</Link>
        </Button>
      </div>
