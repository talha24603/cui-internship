...
export default function FacultyInternshipDetailPage() {
  ...
  return (
    <FacultyShell title="Internship Details" description="Read weekly logs and final report evaluation in full view.">
      <div className="mb-4">
        <Button asChild variant="outline" size="sm">
          <Link href="/faculty/internships">Back to internships</Link>
        </Button>
      </div>
                ...
                <div key={log.id} className="rounded-lg border border-slate-200 p-3 dark:border-slate-700">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <Button asChild size="sm" variant="outline">
                      <Link href={`/faculty/internships/${internshipId}/weekly-logs/${log.id}`}>Open full page</Link>
                    </Button>
                  </div>
